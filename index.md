...
<section id="about">
    <h3>About Me</h3>
    <p>I work on both Technical AI Safety and Governance, currently interested in AI Control and predicting failures of "Automated Alignment". In 2023, I co-founded the <a href="https://ai-standards-lab.org/" target="_blank">AI Standards Lab</a>, a 501(c)(3) supporting EU standards and the recent Codes of Practice - which has been funded at $600k+, and was a key player in the success of the final CoP. I've transitioned to an advisory/board role to focus on technical research.</p>
